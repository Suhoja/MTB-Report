...
RUN		Rscript -e "BiocManager::install(c('shinydashboard','S4Vectors', 'AnnotationDbi', 'XVector', 'Biostrings', 'Biobase', 'GenomeInfoDb', 'VariantAnnotation', 'BiocGenerics', 'EnsDb.Hsapiens.v86', 'IRanges', 'GenomicRanges', 'GenomicFeatures', 'gwascat', 'biomaRt', 'liftOver', 'EnsDb.Hsapiens.v75','maftools','org.Hs.eg.db','rentrez'))"
